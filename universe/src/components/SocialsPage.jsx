    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-white">
      ...
      <main className="container mx-auto px-4 py-12">
        <ul className="space-y-4 text-center">
          <li className="text-xl font-bold">Alumni Network</li>
          <li className="text-xl font-bold">Local Hangout Discoveries</li>
          <li className="text-xl font-bold">Event Connections</li>
        </ul>
      </main>
    </div>
  );
